...
export default function Home() {
    ...
    (
        {
            stroke: {
              ...
              labels: ['00:00', '01:00', '02:00', '03:00', '04:00', '05:00', '05:00', '06:00', '07:00', '08:00', '09:00',
    ...
    const [series_temp, set_series_temp] = useState([
        {
            ...
            data: [32, 35, 36, 35.5, 32, 33, 34, 37.5, 32, 35, 36, 35.5, 32, 33, 34, 37.5, 32, 35, 36, 35.5, 32, 33, 35.5, 32, 37]
        }, 
    ])
    ...
    (
        {
            ...
            xaxis: {
                ...
                categories: ['00:00', '01:00', '02:00', '03:00', '04:00', '05:00', '05:00', '06:00', '07:00', '08:00', '09:00',
                '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00',
                '23:00'],
                title: {
                    text: 'Time'
    ...
    return (
        <div>
            ...
            <div style={{backgroundColor: "#f3f3f2", textAlign: "center"}} className='header'>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div style={{display: "flex", justifyContent: 'space-between'}} className="four-params">
                        <div style={each_param_block} className="param">
                            <div><img style={{width: "30%", paddingTop: "10px"}} src={require('./images/thermometer.png')} alt="" /></div>
                            <div style={{width: "417px"}}>
                                <span style={{fontSize: "20px", fontWeight: "light"}}>Temperature</span> <br></br>
                                <span style={{fontSize: "25px", fontWeight: "bold"}}>10 &#8451;</span>
                            </div>
                        </div>
                        <div style={each_param_block} className="param">
                            <div><img style={{width: "30%", paddingTop: "10px"}} src={require('./images/sunny.png')} alt="" /></div>
                            <div style={{width: "417px"}}>
                                <span style={{fontSize: "20px", fontWeight: "light"}}>Light Intensity</span> <br></br>
                                <span style={{fontSize: "25px", fontWeight: "bold"}}>980</span>
                            </div>
                        </div>
                        <div style={each_param_block} className="param">
                            <div><img style={{width: "30%", paddingTop: "10px"}} src={require('./images/soil.png')} alt="" /></div>
                            <div style={{width: "417px"}}>
                                <span style={{fontSize: "20px", fontWeight: "light"}}>Soil Moisture</span> <br></br>
                                <span style={{fontSize: "25px", fontWeight: "bold"}}>40%</span>
                            </div>
                        </div>
                        <div style={each_param_block} className="param">
                            <div><img style={{width: "30%", paddingTop: "10px"}} src={require('./images/drop.png')} alt="" /></div>
                            <div style={{width: "417px"}}>
                                <span style={{fontSize: "20px", fontWeight: "light"}}>Humidity</span> <br></br>
                                <span style={{fontSize: "25px", fontWeight: "bold"}}>65%</span>
                            </div>
                        </div>
                    </div>
                </div>

                <div className="row temperature-statistic" style={{marginTop: "50px"}}>
